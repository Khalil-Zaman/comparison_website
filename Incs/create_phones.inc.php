<div class="results_heading_2"style="width:968px; top:10px; left:10px; position:relative;">Create Phone Comparison</div>
<?php
		...
		<td class="tdCreate showDetails" style=" background-color:white;">
			...
			<div class="compBox" style="height:276px;">
				<table  <?php if($choice_id[$x]==$choice1){ echo "id='this_one'"; }?> class="comparison_select tdTableCreate">
					...
					<tr style="z-index:1;">
						<td id="pic" style="z-index:1; height:222px; width:217px;">
...
<table style="background-color:white; width:230px;border-collapse:collapse;" ><!-- SEARCH BAR -->
	<tr>
		<td id="comparison_search">
			<div class="search_nav_heads" id="phones_search">
				Search
			</div>
		</td>
	</tr>
	<tr>  
		<td>
			<div  id="search_options_phones" style="border:1px solid #CCCCCC; position:relative;top:-4px;  border-top:0;">
				<table>
									
					<form method="GET" action="<?php echo curPageUrl();?>">
						<input type="hidden" readonly="true" name="cat" value="phones-c" />
						<?php if (strpos($pageURL, "choice1=") !== false){?>
							<input type="hidden" readonly="true" name="choice1" value="<?php echo $choice1."-c1";?>"/>
						<?php } ?>
						<tr>
							<td style="position:relative; left:5px; text-align:center;"><div class="divSearchFields" style="position:relative; left:43px;">Search For A Phone</div></td>
						</tr>
						<tr>
					...
					<form method="GET" action="<?php echo curPageUrl();?>">
						...
						<?php if (strpos($pageURL, "choice1=") !== false){?>
							<input type="hidden" readonly="true" name="choice1" value="<?php echo $choice1."-c1";?>"/>
						<?php } ?>
						<?php require("Incs/phones_searchTable.inc.php");?>
					</form>
				</table>
			</div>
		</td>
