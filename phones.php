...
<div id="wrapper">
<div id="wrapper_2">
<div id="content" style="padding-bottom:250px;">
...
<div class="results_heading_2 topTitle">Top Phone Comparisons Today</div><!-- TOP COMPARISONS DISPLAY BOX -->
<table class="compTable">
	<tr>
		...
		<td colspan="1" rowspan="3" style="border:1px solid #CCCCCC;" ><!-- DISPLAYING RIGHT HAND SIDE BOX WITH TOP COMPARISONS -->
			<div id="table-scroll"  style="height:503px;">
			...
			?>
				...
				<td class="top_results_comparison"><a  href="compare.php?phones-c<?php echo $pageURLArray[$x]."-gc";?>"><?php echo $choice1_name[$x]." <span style='color:orange;'>vs</span> ".$choice2_name[$x];?></a></td></tr>
			<?php
			}
			?>
			</table>
...
for ($x=0;$x<count($choice1_name_search);$x++){
	if (($x%3)==0){echo "<tr>";};?>
		...
		<div class="compBox">
		<a href="compare.php?phones-c<?php echo $pageURL_search[$x]."-gc";?>" >
...
<table style="border-collapse:collapse; border-spacing: 0; position:relative; top:12px;">
<?php
for ($x=0;$x<count($pageUrl_latest);$x++){
	if (($x%3)==0){echo "<tr>";};?>
		<td class="comp_select">
		<div class="compBox">
		<a href="compare.php?phones-c<?php echo $pageUrl_latest[$x]."-gc";?>" style="text-decoration:none;">
			<table style=" margin-top:5px; border-collapse:collapse; width:230px;">
				<tr>
					<td colspan="2">
						<img src="Pictures/<?php echo ucfirst($comparison_category)."/".queryULT("pic_name",$comparison_category,"id",$choice1_latest[$x]);?>" class="compResultImgs" style="margin-left:8px;">
					</td>
					<td colspan="2" >
						<div style="height:100px; background-color:green; width:1px;"></div>
					</td>
