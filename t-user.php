...
for ($x=0; $x<count($table);$x++){
	...
	if(strpos($table[$x],'compare_')!==false){
...
<div style="position:relative; width:200px; height:200px; background-color:orange;"></div> <!-- MEDIUM RECTANGLE -->
</div>
</div>
</div>
...
<script type="text/javascript" src="Incs/user_message.inc.js<?php echo time();?>"></script>
</body>
</html>